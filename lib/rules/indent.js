...
module.exports = {
    ...
    create(context) {
        ...
        function getTokenIndent(token) {
            ...
            const indentChars = srcCharsBeforeToken.slice(0, token.loc.start.column);
        ...
        return {
            ...
            "Program:exit"() {
                ...
                sourceCode.lines.forEach((line, lineIndex) => {
                    ...
                    if (!firstTokensByLineNumber.has(lineNumber)) {

                        // Don't check indentation on black lines
                        return;
                    }

                    const firstTokenofLine = firstTokensByLineNumber.get(lineNumber);
                    ...
                    if (validateTokenIndent(firstTokenofLine, getDesiredIndent(firstTokenofLine))) {
                        return;
                    }
                    ...
                    if (astUtils.isCommentToken(firstTokenofLine)) {
                        ...
                        if (
                            tokenBefore && validateTokenIndent(firstTokenofLine, getDesiredIndent(tokenBefore)) ||
                            tokenAfter && validateTokenIndent(firstTokenofLine, getDesiredIndent(tokenAfter))
                        ) {
                            return;
                        }
                    }
                    ...
                    report(firstTokenofLine, getDesiredIndent(firstTokenofLine));
                });
            }
